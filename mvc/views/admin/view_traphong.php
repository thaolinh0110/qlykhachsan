                        ...
                        <div class="col-md-12">
                            <div class="card card-box">
                                <div class="card-head"  style="background-color: #ADD8E6;border-radius: 5px; padding: 2px;">
                                    <header>Danh Sách Trả Phòng</header>
                                    <div class="tools">
                                                ...
                                                foreach($list_room  as $row_r){
                                                    ...
                                                    $thanh_toan  = $row_r['thanh_toan'];
																	if($thanh_toan == "Thanh Toán Ngay"){
																		...
																		echo ' <td class="text-center"><span class="badge badge-success">Checked-Out</span></td>';

																	}else{
																		echo '<td class="center"> Chưa Thanh Toán</td>';
																		echo ' <td class="text-center"><span class="badge badge-warning">Checked-In</span></td>';
