 ...
 <div class="wrapBreadCrumb">
            ...
            <div class="wrapTextBreadcrumb">
                <div class="container-xl containerTextBreadcrumb">
                    <h1 class="wrapTitleType2 titlePageCurrentBreadcrumb">Hướng đến không gian thoáng mát</h1>
                    ...
                    <nav aria-label="breadcrumb" class="navListBreadcrumb">
                        <ol class="breadcrumb olListBreqadcrumb">
                            ...
                            <li class="breadcrumb-item itemListBreadcrumb active" aria-current="page">Hướng đến không gian thoáng mát</li>
                        </ol>
                    </nav>
                </div>
            </div>
